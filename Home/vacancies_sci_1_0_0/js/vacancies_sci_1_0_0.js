...
const recruitCard = (data) => {
  return ` <div class="vacancies_sci_1_0_0__item">
    <div class="vacancies_sci_1_0_0__name">
        <p>${data.name}</p>
        <span><img width="15" height="15" src="/Home/vacancies_sci_1_0_0/images/calendar.svg" alt="">Deadline:
            ${data.deadline}</span>
        <span><img width="15" height="15" src="/Home/vacancies_sci_1_0_0/images/map.svg" alt="">Địa điểm: ${data.location}</span>
    </div>
